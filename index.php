...
<html lang="ru">
<head>
<title>Всё о тестировании</title>
<meta charset="utf-8">
<meta name="description" content="Самая важная инфа своими словами :)">
<meta name="keywords" content="Всё о теории тестировании">

<?php include 'lib/module/sys-meta.php';?>
<meta property="og:title" content="Tstng87" />
<meta property="og:description" content="Tstng87" />
...
<meta name="twitter:title" content="Tstng87">
<meta name="twitter:description" content="Tstng87">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Всё о тестировании<br>
							 от А до Я</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 Самая важная инфа своими словами :)
							</p>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 Форум тестировщиков. Новости в мире тестирования, горячие обсуждения прохождения уровней и просто вопросы в области QA
								</p>
							</div>
							<a href="https://t.me/qachanell" target="_blank">
							<div class="discord-btn-button">
								<div class="discord-ico-button">
								</div>
								<div class="discord-tx1-button">
									<span>Присоединяйся в Tg</span>
								</div>
							</div>
							</a>
						</div>
